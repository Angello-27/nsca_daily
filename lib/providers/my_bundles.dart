...
import '../models/bundle_courses_model.dart';
import '../models/bundle_details_model.dart';
      ...
      for (var bundleData in extractedData) {
        loadedBundleDetails.add(
          BundleDetails(
            ...
            averageRating: bundleData['average_rating'],
            numberOfRatings: bundleData['number_of_ratings'],
            bundleCourses: buildBundleCourses(
              bundleData['bundle_courses'] as List<dynamic>,
            ),
          ),
        );
      }
      ...
      for (var sectionData in extractedData) {
        loadedSections.add(
          Section(
            ...
            mLesson: buildSectionLessons(
              sectionData['lessons'] as List<dynamic>,
            ),
          ),
        );
      }
