  ...
  void didChangeDependencies() {
    if (_isInit) {
      ...
      if (pageDataType == CoursesPageData.Category) {
        ...
        Provider.of<Courses>(context).fetchCoursesByCategory(categoryId).then((
          _,
        ) {
          setState(() {
            _isLoading = false;
        ...
        Provider.of<Courses>(
          context,
        ).fetchCoursesBySearchQuery(searchQuery).then((_) {
          setState(() {
            _isLoading = false;
          });
        });
        ...
        Provider.of<Courses>(
          context,
        ).filterCourses('all', 'all', 'all', 'all', 'all').then((_) {
          setState(() {
            _isLoading = false;
          });
        });
